...
<div class="carusel-promociones">
    ...
    <div class="row especial-pading">
        <div class="box">
            <div class="info pading-7">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit corrupti, 
                    est quibusdam sapiente necessitatibus animi culpa maxime earum beatae 
                    asperiores excepturi quia, repellendus rem consequuntur recusandae ut 
                    voluptates cupiditate magni.</p>
            </div>
            <img src="../img/fondos/mision.jpg">
            <span>Misión</span>
        </div>
        <div class="box">
            <p class="info pading-7">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit corrupti, est quibusdam sapiente necessitatibus animi culpa maxime earum beatae asperiores excepturi quia, repellendus rem consequuntur recusandae ut voluptates cupiditate magni.</p>
            <img src="../img/fondos/vision.jpg">
            <span>Visión</span>
        </div>
        <div class="box">
            <p class="info pading-7">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit corrupti, est quibusdam sapiente necessitatibus animi culpa maxime earum beatae asperiores excepturi quia, repellendus rem consequuntur recusandae ut voluptates cupiditate magni.</p>
            <img src="../img/fondos/nosotros.jpg">
            <span>Nosotros</span>
        </div>
        
    </div>
    <!-- Seccion pagos y horarios -->
    <div class="row my-3">
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 pagos-horarios">
            <h4>Horarios de atención</h4> 
            <img src="../img/iconos/calendario.png" alt="" class="icon2"> 
            <p class="my-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab veniam, eaque cupiditate ipsam quasi vitae id quos non adipisci maxime, consectetur sed provident magnam blanditiis amet. Blanditiis sit perferendis facilis!</p>
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 pagos-horarios">
            <h4>Metodos de Pago</h4>
            <img src="../img/iconos/salario.png" alt="" class="icon2 "> 
            <p class="my-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, aspernatur non mollitia distinctio asperiores minus quos veritatis, consequuntur recusandae alias, error tempore? Voluptatem laboriosam blanditiis aspernatur eaque dolorum sit inventore!</p>
        </div>
    </div>
