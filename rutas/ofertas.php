...
<div class="carusel-promociones">
    ...
    <!--Seccion 1 -->
    <div class="row">
    <div class="col-12 my-3 oferta">
        <h2>¡ Grandes descuentos en Fruver La Huerta !</h2>
        <img src="../img/ofertas/frutas.png" class="w-100" alt="">
    </div>
  </div>
  <!--Seccion 2 -->
  <div class="row p-1 align-content-center d-flex justify-content-center">
    ...
    <div class="row pading-7">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1 oferta">
            <img src="../img/ofertas/naranjas.png" class="w-100">
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1 oferta">
            <img src="../img/ofertas/brocoli.png" class="w-100">
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 p-1 oferta">
            <img src="../img/ofertas/sandia.png" class="w-100">
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1 oferta">
            <img src="../img/ofertas/papaspastusas.png" class="w-100">
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1 oferta">
            <img src="../img/ofertas/manzanaverde.png" class="w-100">
        </div>
    ...
    <div class="row pading-7">
        <h2>Supermercado</h2>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1 oferta">
            <img src="../img/ofertas/arrozdiana.png" class="w-100">
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1 oferta">
            <img src="../img/ofertas/aceitesolisoya.png" class="w-100">
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 p-1 oferta">
            <img src="../img/ofertas/supermercado.png" class="w-100">
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1 oferta">
            <img src="../img/ofertas/lechealqueria.png" class="w-100">
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-1 oferta">
            <img src="../img/ofertas/salsasbary.png" class="w-100">
        </div>
    </div>
    <!-- seccion 5 -->
    <div class="row align-content-center d-flex justify-content-center">
        <div class="col-12 my-3">
            <h2>Descuentos para ti</h2>
        </div>
        <div class="col-6 col-sm-4 col-md-3 col-lg-2 ">
            <div class="row p-1"> 
