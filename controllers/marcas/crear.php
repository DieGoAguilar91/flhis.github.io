<?php
 ...
 include "../funciones.php";
  ...
  $resultado = [
    'error' => false,
    'mensaje' => 'El Marca ' . escapar($_POST['nombre']) . ' ha sido agregado con éxito ✅'
  ];
  ...
  try {
    ...
    $consultaSQL = "INSERT INTO marca (NOMBRE_MARCA, ID_CATEGORIA , ID_MARCA , PRESENTACION, PRECIO ,DESCRIPCION, ESTADO)";
    $consultaSQL .= "values (:" . implode(", :", array_keys($marca)) . ")";
...
<div class="row">
  <div class="col-md-12">
    <h2 class="mt-4">Crear un Marca</h2>
    <hr>
