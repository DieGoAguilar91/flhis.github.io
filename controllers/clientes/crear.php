...
if (isset($_POST['submit'])) {
  ...
  try {
    ...
    $consultaSQL = "INSERT INTO cliente (NOMBRE_CLIENTE, APELLIDO_CLIENTE, EMAIL, TELEFONO ,GENERO,TIPO_DE_DOCUMENTO, NUMERO_DOCUMENTO, DIRECCION, ESTADO, CLAVE, TIPOUSUARIO)";
...
<div class="row">
  <div class="col-md-12">
    <h2 class="mt-4">Crear un cliente</h2>
    <hr>
